...
export function MermaidDiagram({ code }: MermaidDiagramProps) {
  ...
  if (error) {
    return (
      <details className="my-6 rounded-xl border border-border bg-muted/25 p-4 text-sm">
  ...
  return (
    <div className="my-6 overflow-x-auto rounded-xl border border-border bg-card p-4 sm:p-6">
      {svg ? (
        <div
        ...
        <div className="h-48 animate-pulse rounded-lg bg-muted/70" aria-label="Rendering architecture diagram" />
      )}
    </div>
  );
}
