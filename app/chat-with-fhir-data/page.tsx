          ...
          <section className="container max-w-3xl py-8">
            ...
            <div className="mt-4 space-y-4 text-lg leading-relaxed text-muted-foreground">
              ...
              <p>
                ...
                application layer: a ready-to-run chat UI with bounded FHIR
                read and write tools and the approval card built in. It runs
                on Medplum, or fully locally on HAPI FHIR. Additional backends
                plug in through the FhirBackend adapter seam. It also
                publishes a separate MCP package: chart-read tools by
                default, with an opt-in write profile where every write is an
                elicitation-gated proposal a human approves per action. Use
                the chat UI when you want an approval card in
